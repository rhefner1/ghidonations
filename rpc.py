...
#### ---- TEMPORARY TEST FUNCTIONS - SHOULD BE HIDDEN ON PRODUCTION RELEASE ---- ####
    ...
    def pub_refreshSandbox(self):
        ...
        s.create.donation("Sandra Baker", "sbaker@example.com", "12.34", None, None, None, True, None, None, "offline", False, False, False)
        ...
        s.create.donation("Constance Weekley", "cweekley@example.com", "6000.00", None, None, None, True, None, None, "offline", False, False, False)
