...
class SettingsCreate(UtilitiesBase):
    ...
    def donation(self, name, email, amount_donated, address, team_key, individual_key, add_deposit, payment_id, special_notes, payment_type, reviewed, cover_trans, email_subscr):
