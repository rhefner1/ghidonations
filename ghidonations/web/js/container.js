...
function add_email_handler() {
    $('#add_email').click(function (e) {
        e.preventDefault();
        var to_add = '<label style="clear:both" class="email~"></label>' + '<div class="input email~" style="margin-top:5px">' + '<input class="large validate[custom[email]] email_address" style="float:left" type="text" name="email~" value="" />' + '<span style="margin-top:5px; cursor:pointer" data-number="~" class="ui-icon ui-icon-minus remove_email"></span>' + '</div>';
