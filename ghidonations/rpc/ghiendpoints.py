...
import ghidonations.spreadsheet_pipelines
from ghidonations import tools
from ghidonations.rpc.endpoints_messages import *
...
class EndpointsAPI(remote.Service):
    ...
    def get_contacts(self, req):
        is_admin, s = tools.checkAuthentication(self, True, from_endpoints=True)
    ...
    def mailchimp_lists(self, req):
        tools.checkAuthentication(self, True, from_endpoints=True)
    ...
    def semi_get_individual_donations(self, req):
        is_admin, s = tools.checkAuthentication(self, False, from_endpoints=True)
    ...
    def semi_get_team_members(self, req):
        ...
        tools.checkAuthentication(self, False, from_endpoints=True)
    ...
    def new_individual(self, req):
        ...
        if not email or exists[0] is False:
    ...
    def new_offline_donation(self, req):
        ...
        name, email, amount_donated, notes, address, team_key, individual_key, add_deposit = \
            req.name, req.email, tools.toDecimal(req.amount_donated), req.notes, req.address, req.team_key, \
            req.individual_key, req.add_deposit
    ...
    def get_contacts_json(self, req):
        ...
        return JSON_Out(json_data=s.data.contacts_json)
    ...
    def spreadsheet_start(self, req):
        ...
        stage = ghidonations.spreadsheet_pipelines.GenerateReport(s.websafe, req.mode, job_id)
